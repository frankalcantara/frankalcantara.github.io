...
_Figure 2.1.G: Diagram of the asynchronous I/O operations showing a support threading runnib only for I/O_{: class="legend"}
...
## 2.4. Data Structure Manipulation in C++20

Modern C++20 provides powerful tools and abstractions for handling structured data efficiently. This section explores three fundamental approaches to managing and manipulating data collections: vectors for one-dimensional data structures, matrices for two-dimensional data arrangements, and spans and ranges for flexible data views and iterations. These mechanisms form the backbone of efficient data handling in competitive programming and general-purpose applications.

### 2.4. Working with Vector and Matrix
...
#### 2.4.2. Vectors as Inputs and Outputs
...
#### 2.4.3. Optimized Version Using `fread` and `putchar` with Command-Line File Input
...
### 2.5.1 Creating and Filling a Matrix
...
### 2.2.6 Inserting Elements at a Specific Position
...
### 2.5.4 Removing the Last Element and a Specific Element
...
### 2.5.5 Creating a New Vector with a Default Value
...
### 2.5.6 Resizing and Filling with Random Values
...
This code resizes the matrix to 3x3 and fills it with random values between 1 and 2.8.

### 2.5.7 Sorting Matrices by Rows and Columns
...
### 2.5.8 Optimizing Matrix Input and Output in Competitive Programming
...
##### 2.5.8.1 Optimized Reading with `fread`
...
##### 2.5.8.2 Optimized Output with `putchar_unlocked`
...
##### 2.5.8.4 Using `mmap` on Unix Systems for Matrices
...
##### 2.6.1.1 Efficient Use Cases for `std::span`
...
##### 2.6.1.2 Comparing `std::span` to Traditional Methods
...
#### 2.6.1.3 Practical Application: Using `std::span` in Competitive Programming
...
## 2.7 Data Manipulation with `std::ranges`
