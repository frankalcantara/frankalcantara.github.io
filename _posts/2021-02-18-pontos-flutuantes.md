...
Em uma estrada, a diferença de um centímetro que existe entre $12,00m$ e $12,01m$ provavelmente não fará qualquer diferença. Se estivermos construindo um motor, por outro lado, um erro de $1cm$ será a diferença entre funcionar e explodir. Maximize este conceito imaginando-se no lugar de um um físico precisando utilizar a constante gravitacional. Neste caso, a leitora terá o desprazer de fazer contas com números como $0.00000000006667_{10}$.
